			...
			<GlassCard class="space-y-6">
				...
				<div class="text-center">
					<div class="inline-flex items-center justify-center w-16 h-16 rounded-full glass-effect mb-4">
						<LogIn class="w-8 h-8 text-blue-400" />
					</div>
				...
				>
					...
					<div class="flex items-center justify-between text-sm">
						<label class="flex items-center gap-2 text-gray-400 cursor-pointer">
							<input type="checkbox" class="rounded border-white/20 bg-white/5 text-blue-500 focus:ring-blue-500/50" />
							Lembrar de mim
						</label>
						<a href="/forgot-password" class="text-blue-400 hover:text-blue-300 transition-colors">
							Esqueci minha senha
						</a>
					</div>
				...
				<div class="text-center text-sm text-gray-400">
					Não tem uma conta?
					<a href="/register" class="text-blue-400 hover:text-blue-300 transition-colors font-semibold">
						Cadastre-se
					</a>
				</div>
			</GlassCard>
